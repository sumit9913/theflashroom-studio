        ...
        <div className="prose prose-invert max-w-none">
          ...
          <ul>
            <li>
              ...
              event type, event date, location, budget, and your
          ...
          <p>
            ...
            share limited data with trusted service providers only when needed
            to run our business (example: website hosting, email tools, form
            processing, analytics), and only for the purposes described here.
          </p>
          <p>
          ...
          <p>
            ...
            writing during/after a project). You can withdraw consent for future
            use by contacting us. Withdrawal does not affect past lawful use.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Client project data:</strong> retained for a reasonable
              period to deliver services, provide support, and maintain backups
              (duration may depend on project scope and storage constraints).
            </li>
            <li>
          ...
          <p>
            ...
            controls, secure services, and best-practice handling). However, no
          ...
          <p>
            ...
            information, and you can object/restrict certain processing where
            applicable. To make a request, email{' '}
          ...
          <p>
            ...
            without a parent/guardian. If you believe a child has provided data,
