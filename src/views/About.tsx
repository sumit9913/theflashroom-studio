...
const teamMembers = [
  ...
  },
  {
    name: 'Jude Theo',
    role: 'Editor',
    bio: 'Jude brings stories to life in post-production, blending seamless cuts and color grading to deliver polished, emotive final edits.',
  },
  {
    name: 'Ria Sing',
    role: 'Creative Handler',
    bio: 'Ria bridges creative ideas and execution, ensuring every concept is thoughtfully developed and consistently brought to life.',
  },
  {
    name: 'Manasi Maurya',
    role: 'Mrs.Admin',
