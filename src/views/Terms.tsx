    ...
    <section className="section-padding bg-background">
      <div className="container-custom max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none">
          <p>
            These Terms govern your use of <strong>{SITE_NAME}</strong> website
            and any inquiry/booking you make with us. By using this site, you
          ...
          <p>
            ...
            A booking is confirmed only after written confirmation and (if
            applicable) receipt of an advance payment.
          </p>
          ...
          <p>
            ...
            films). We'll share an estimated timeline at booking. Delays due to
            factors outside our control (venue restrictions, weather, force
            majeure) may affect delivery.
          </p>
          ...
          <ul>
            ...
            <li>
              You receive a personal-use license to view, share, and print your
              delivered media for personal purposes.
            </li>
            <li>
              Commercial use (ads, brand promotions, paid campaigns) requires
              written permission.
            </li>
          </ul>
          ...
          <p>
            ...
            related to a booking is limited to the amount paid for that booking
            (unless otherwise required by law).
          </p>

          <h2>10) Third-party links</h2>
          <p>
            The site may link to third-party platforms (e.g., Instagram). We are
