...
export default function PortfolioAlbum() {
    ...
    // ✅ If album not found -> 404 route (or redirect)
    ...
    }, [selectedIndex, closeLightbox, prev, next]);
    ...
    return (
        <>
            <Helmet>
                <title>{album.title} | {album.category} Photography in {album.location} | The Flash Room Studio</title>
                <meta
                    name="description"
                ...
                <section className="relative pt-28 pb-14 lg:pt-36 lg:pb-16 overflow-hidden">
                    ...
                    <div className="container-custom relative z-10">
                        ...
                        >
                            ...
                            {/* SEO helper */}
                            <p className="sr-only">
                                {album.title} {album.category.toLowerCase()} photography album in {album.location} by The Flash Room Studio
                            </p>
                        </motion.div>
                    </div>
                </section>
                        ...
                        <motion.div layout className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                            {album.images.map((img, index) => (
                                <motion.button
                                    ...
                                    className={`relative overflow-hidden rounded-lg aspect-square group text-left ${index % 7 === 0 ? "md:col-span-2 md:row-span-2 md:aspect-auto" : ""
                                        }`}
                                >
                                    <img
                                        src={img}
