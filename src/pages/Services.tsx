...
import { Heart, Camera, Users, Baby, Cake, Film, Check, ArrowRight } from "lucide-react";
...
const services = [
  {
    ...
    description: "From the sacred pheras to the joyous celebrations, we document every ritual, emotion, and moment of your wedding day. Our team captures candid moments, traditional ceremonies, and cinematic highlights that you'll treasure forever.",
    features: [
  ...
  },
  {
    ...
    description: "Create stunning memories before the big day with our artistic pre-wedding shoots. Whether it's a palace backdrop, serene beach, or your favorite café, we bring your love story to life with creative concepts and beautiful locations.",
    features: [
  ...
  },
  {
    ...
    description: "From corporate gatherings to intimate family reunions, we provide comprehensive event coverage that captures the essence of your celebration. Our discrete approach ensures natural, candid moments.",
    features: [
  ...
  },
  {
    ...
    description: "Celebrate the joy of new life with our specialized baby shower and maternity photography. We capture the glow, the excitement, and the love surrounding this beautiful phase of life.",
    features: [
  ...
  },
  {
    ...
    description: "From first birthdays to milestone celebrations, we capture the joy, laughter, and love that make each birthday special. Our creative approach ensures vibrant, joyful photos.",
    features: [
...
export default function Services() {
  return (
    <>
      <Helmet>
        <title>Photography & Videography Services in Mumbai | The Flash Room Studio</title>
        <meta
          name="description"
          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-6xl font-bold mt-4 mb-6">
                Professional <span className="text-gold-gradient">Photography</span> Services
              </h1>
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className={index % 2 === 1 ? "lg:order-1" : ""}>
                    ...
                    <p className="text-gold font-elegant text-lg mb-6">{service.subtitle}</p>
                    <p className="sr-only">
                      {service.title.toLowerCase()} services in Mumbai by The Flash Room Studio
                    </p>
          ...
          <div className="container-custom text-center">
            ...
            >
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-6">
                Not Sure Which Service <span className="text-gold-gradient">You Need</span>?
              </h2>
              <p className="text-muted-foreground max-w-2xl mx-auto mb-10">
                Every celebration is unique. Let's discuss your requirements and create
                a custom package that perfectly fits your needs and budget.
              </p>
