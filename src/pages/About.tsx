  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="About The Flash Room Studio | Mumbai" />
        <meta
          ...
          <div className="container-custom relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                TheFlashRoom Studio is a Mumbai-based wedding photography and videography team
                capturing the rich cultural tapestry of Indian celebrations — from intimate ceremonies
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    What started as a love for capturing candid moments evolved into a studio trusted
                    for premium wedding photography and cinematic films across India.
                  </p>
                  <p>
                    From intimate home ceremonies to destination weddings, we approach each project
                    with the same dedication and storytelling focus.
                  </p>
                  <p>
                    We don’t just take photos — we create visual legacies that families cherish for
                    generations.
                  </p>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Link to="/portfolio">
                    <Button variant="gold-outline" size="lg">View Portfolio</Button>
                  </Link>
                  <Link to="/packages">
                    <Button variant="gold" size="lg">See Packages</Button>
                  </Link>
                </div>
              </motion.div>
            </div>
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                A dedicated Mumbai-based crew of photographers, filmmakers, editors and creators.
              </p>
            </motion.div>
          ...
          <div className="container-custom text-center">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto mb-10">
                Tell us about your event and we’ll suggest the right package (Mumbai + Pan-India + destination).
              </p>
